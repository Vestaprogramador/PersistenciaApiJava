...
CREATE TABLE Tipos_jornada (
    id_jornada INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
...
CREATE TABLE Tipos_modalidad (
    id_tipo_modalidad INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
    nombre VARCHAR(150) NOT NULL,
    descripcion VARCHAR(250) NOT NULL,
    estado_registro BOOLEAN NOT NULL DEFAULT TRUE,
    fecha_creacion_registro DATE NOT NULL,
...
CREATE TABLE Convocatorias (
    id_convocatoria INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
    ...
    CONSTRAINT FK_titulo_unico_convocatorias UNIQUE (titulo)
);

CREATE TABLE Estados_postulacion (
    id_estado_postulacion INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1 ) NOT NULL,
    nombre VARCHAR(150) NOT NULL,
    descripcion VARCHAR(250) NOT NULL,
    estado_registro BOOLEAN NOT NULL DEFAULT TRUE,
    fecha_creacion_registro DATE NOT NULL,
...
CREATE TABLE Resoluciones_postulacion (
    id_resolucion_postulacion INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
    nombre VARCHAR(150) NOT NULL,
    descripcion VARCHAR(250) NOT NULL,
    estado_registro BOOLEAN NOT NULL DEFAULT TRUE,
    fecha_creacion_registro DATE NOT NULL,
...
CREATE TABLE Postulaciones (
    id_postulacion INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
